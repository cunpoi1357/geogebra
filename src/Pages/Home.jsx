...
function Home() {
    ...
    return (
        <>
            <Helmet>
                <title>StudyGeo3D.com - Website hỗ trợ học hình học không gian</title>
            </Helmet>
            <section>
                <div className='bg-[#8087d8] px-6 pb-10 pt-4'>
                    ...
                    <h1 className='pt-6 pb-8 text-4xl text-center text-white'>
                        WEBSITE HỖ TRỢ HỌC HÌNH HỌC KHÔNG GIAN
                    </h1>
