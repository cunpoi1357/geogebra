    ...
    return (
        <section className='min-h-[calc(100vh-236px)] lg:px-16 px-4'>
            ...
            <div className='text-[#0060a7] text-lg'>
                ...
                <p>
                    Nhóm trưởng: <span className='uppercase'>Nguyễn Việt Hoàng</span>, học sinh lớp 12B6, trường THPT
                    Trần Đại Nghĩa, huyện Buôn Đôn.
                </p>
                <p>
                    Thành viên: <span className='uppercase'>Trần Quốc Khánh</span>, học sinh lớp 12B5, trường THPT Trần
